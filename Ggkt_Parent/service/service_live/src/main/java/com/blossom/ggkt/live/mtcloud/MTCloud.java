...
package com.blossom.ggkt.live.mtcloud;

import com.blossom.ggkt.live.mtcloud.utils.MD5Util;
...
public class MTCloud {
     ...
     * 合作方ID： 合作方在欢拓平台的唯一ID
     */
    public String openID = "59629";

    /**
     * 合作方秘钥： 合作方ID对应的参数加密秘钥
     */
    public String openToken = "1fdde4516787b7358089def2f509429b";
